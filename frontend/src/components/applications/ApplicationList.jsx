...
//   if (!company || failed) {
//     return (
//       <span className="company-logo company-logo--sm company-logo--fallback">
//         {initial}
//       </span>
//     );
//   }
...
//   var appsState = useSelector(function (state) {
//     return state.applications;
//   });

//   var reduxItems = appsState.items;
//   var reduxCurrentPage = appsState.currentPage;
//   var reduxTotalPages = appsState.totalPages;
//   var reduxLoading = appsState.loading;
//   var successMessage = appsState.successMessage;
//   var warningMessage = appsState.warningMessage;
//   var reduxError = appsState.error;
...
//    * Local GET-ALL data.
//    *
//    * This allows ApplicationList to render the response returned by
//    * applicationService.getAll(), which is what T17 mocks.
//    */
...
//   var localPageState = useState(0);
//   var localCurrentPage = localPageState[0];
//   var setLocalCurrentPage = localPageState[1];

//   var localTotalPagesState = useState(1);
//   var localTotalPages = localTotalPagesState[0];
//   var setLocalTotalPages = localTotalPagesState[1];

//   var localLoadingState = useState(false);
//   var localLoading = localLoadingState[0];
//   var setLocalLoading = localLoadingState[1];

//   var localErrorState = useState(null);
//   var localError = localErrorState[0];
//   var setLocalError = localErrorState[1];
...
//   var items = isCandidate ? reduxItems : localItems;
//   var currentPage = isCandidate
//     ? reduxCurrentPage
//     : localCurrentPage;

//   var totalPages = isCandidate
//     ? reduxTotalPages
//     : localTotalPages;

//   var loading = isCandidate ? reduxLoading : localLoading;
//   var error = reduxError || localError;

//   var filteredItems = items.filter(function (app) {
//     var fullName =
//       app.candidate && app.candidate.user
...
//         fullName
//           .toLowerCase()
//           .indexOf(candidateFilter.toLowerCase()) !== -1);

//     var matchesStage =
//       !stageFilter ||
//       app.currentStage === stageFilter;
...
//           <div
//             className={
//               'row-list-head applications-grid' +
...
//             var jobTitle = app.job
//               ? app.job.title
//               : null;

//             var companyName = app.job
//               ? app.job.company
//               : null;

//             var appliedDate = app.appliedAt
...
//               <div
//                 className={
//                   'row-list-row applications-grid' +
//                   (canEditStage ? '' : ' no-actions')
//                 }
//                 key={app.id}
//               >
